...
namespace xann {
    ...
    static turbo::Status initialize_l0_l2_operator(MetricRegistry &r) {
        ////////////////////////////////////////
        /// SimdLevel::SIMD_NONE
        /// uint8
        {
            ...
            u8.distance_vector = simple_l2_distance<uint8_t>;
            u8.norm_vector = simple_l2_norm<uint8_t>;
        ...
        /// half
        {
            ...
            hf.distance_vector = simple_l2_distance<half_float::half>;
        ...
        /// f32
        {
            ...
            f32.distance_vector = simple_l2_distance<float>;
    ...
    static turbo::Status initialize_sse2_l2_operator(MetricRegistry &r) {
        ...
        /// f32
        {
            ...
            f32.data_type = DataType::DT_FLOAT;
            f32.normalize_vector = nullptr;
            f32.distance_vector = simd_distance_l2<xsimd::sse3>;
    ...
    static turbo::Status initialize_avx2_l2_operator(MetricRegistry &r) {
        ...
        /// f32
        {
            ...
            f32.data_type = DataType::DT_FLOAT;
            f32.normalize_vector = nullptr;
            f32.distance_vector = simd_distance_l2<xsimd::avx2>;
    ...
    turbo::Status initialize_l2_operator(MetricRegistry &r) {
        auto rs = initialize_l0_l2_operator(r);
        if (!rs.ok()) {
            return rs;
        }

        rs = initialize_sse2_l2_operator(r);
        if (!rs.ok()) {
            return rs;
        }

        rs = initialize_avx2_l2_operator(r);
        if (!rs.ok()) {
            return rs;
        }
