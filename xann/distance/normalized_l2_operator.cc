...
namespace xann {
    ...
    static turbo::Status initialize_l0_nor_l2_operator(MetricRegistry &r) {
        ////////////////////////////////////////
        /// SimdLevel::SIMD_NONE
        /// half
        {
            ...
            hf.metric = kNormalizedL2;
            hf.data_type = DataType::DT_FLOAT16;
            hf.normalize_vector = simple_normalize_l2<half_float::half>;
            hf.distance_vector = simple_normalized_l2_distance<half_float::half>;
        ...
        /// f32
        {
            ...
            f32.metric = kNormalizedL2;
            f32.data_type = DataType::DT_FLOAT;
            f32.normalize_vector = simple_normalize_l2<float>;
            f32.distance_vector = simple_normalized_l2_distance<float>;
    ...
    static turbo::Status initialize_sse2_nor_l2_operator(MetricRegistry &r) {
        ...
        /// f32
        {
            ...
            f32.distance_vector = simd_normalized_l2_distance<xsimd::sse3>;
    ...
    static turbo::Status initialize_avx2_nor_l2_operator(MetricRegistry &r) {
        ...
        /// f32
        {
            ...
            f32.distance_vector = simd_normalized_l2_distance<xsimd::avx2>;
    ...
    turbo::Status initialize_normalized_l2_operator(MetricRegistry &r) {
        auto rs = initialize_l0_nor_l2_operator(r);
        if (!rs.ok()) {
            return rs;
        }

        rs = initialize_sse2_nor_l2_operator(r);
        if (!rs.ok()) {
            return rs;
        }

        rs = initialize_avx2_nor_l2_operator(r);
        if (!rs.ok()) {
            return rs;
        }
