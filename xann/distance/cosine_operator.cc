...
namespace xann {
    ...
    static turbo::Status initialize_l0_cosine_operator(MetricRegistry &r) {
        ////////////////////////////////////////
        /// SimdLevel::SIMD_NONE
        /// uint8
        {
            ...
            u8.distance_vector = simple_cosine_distance<uint8_t>;
        ...
        /// half
        {
            ...
            hf.distance_vector = simple_cosine_distance<half_float::half>;
        ...
        /// f32
        {
            ...
            f32.distance_vector = simple_cosine_distance<float>;
    ...
    static turbo::Status initialize_sse2_cosine_operator(MetricRegistry &r) {
        ...
        /// f32
        {
            ...
            f32.data_type = DataType::DT_FLOAT;
            f32.normalize_vector = nullptr;
            f32.distance_vector = simd_distance_cosine<xsimd::sse3>;
            f32.norm_vector = nullptr;
    ...
    static turbo::Status initialize_avx2_cosine_operator(MetricRegistry &r) {
        ...
        /// f32
        {
            ...
            f32.data_type = DataType::DT_FLOAT;
            f32.normalize_vector = nullptr;
            f32.distance_vector = simd_distance_cosine<xsimd::avx2>;
            f32.norm_vector = nullptr;
    ...
    turbo::Status initialize_cosine_operator(MetricRegistry &r) {
        auto rs = initialize_l0_cosine_operator(r);
        if (!rs.ok()) {
            return rs;
        }

        rs = initialize_sse2_cosine_operator(r);
        if (!rs.ok()) {
            return rs;
        }

        rs = initialize_avx2_cosine_operator(r);
        if (!rs.ok()) {
            return rs;
        }
